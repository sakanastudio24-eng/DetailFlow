  ...
  return (
    <section className="py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <h2 className="mt-2 font-heading text-4xl font-semibold text-brandBlack sm:text-5xl">Simple flow, clear results</h2>
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="mt-2 font-heading text-3xl font-semibold text-brandBlack">{step.title}</h3>
