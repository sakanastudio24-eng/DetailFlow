  ...
  return (
    <section className="bg-white py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <h2 className="mt-2 font-heading text-3xl font-semibold text-brandBlack sm:text-4xl">Results clients can actually see</h2>
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {results.map((item, index) => (
            ...
            >
              <h3 className="font-heading text-xl font-semibold text-brandBlack">{item.title}</h3>
